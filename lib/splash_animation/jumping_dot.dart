...
class DotWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(top: isActive ? 0 : 8),
      decoration: BoxDecoration(
        // shape: BoxShape.circle,
        color: color,
        borderRadius:
            !isActive ? BorderRadius.circular(1000) : BorderRadius.circular(10),
        // border: Border.all(
        //   width: !isActive ? 8 : 1,
        //   color: Colors.white,
      ...
      height: isActive ? radius + 6 : radius,
      width: radius,
    );
  }
}
                    ...
                    child: Transform.translate(
                      ...
                      child: DotWidget(
                        ...
                        isActive: (currentIndex == index &&
                                _animationControllers![currentIndex]
                                    .isAnimating)
                            ? true
                            : false,
                      ),
